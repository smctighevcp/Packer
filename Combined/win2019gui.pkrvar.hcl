...
config_files            = ["config/win-gui/autounattend.xml","scripts/windows/pvscsi","scripts/windows/install-vm-tools.cmd","scripts/windows/enable-winrm.ps1","scripts/windows/psrepo_nuget.ps1","scripts/windows/install-psmodules.ps1"]
